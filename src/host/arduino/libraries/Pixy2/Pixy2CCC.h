...
// Edit By Sam 
//
// Add new function to report block infomation
//
...
struct Block 
{
  ...
  //report block infomation
  uint16_t report_signature(){	
  	return m_signature;
  }
  uint16_t report_x(){
  	return m_x;
  ...
  uint16_t report_width(){
  	return m_width;
  }
  uint16_t report_height(){
  	return m_height;
  }
  int16_t report_angle(){
  	return m_angle;
  } 
